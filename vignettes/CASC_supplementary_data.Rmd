...
deDetection(group="docker", data.folder=getwd(), counts.table="annotated_setPace_10000_noC5_reordered.txt", file.type="txt", logFC.threshold=1, FDR.threshold=0.05, logCPM.threshold=4, shrinking.threshold=1, plot=TRUE)
