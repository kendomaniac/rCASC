...
#### **Section 5.1.1** An example of the use of CASC workflow.
 ...
 For this example we use a subset of data from the [*Pace's Science  paper*](https://www.ncbi.nlm.nih.gov/pubmed/29326266). The available single cell data sets are:
...
We combined 50 cells from **N** and **Nd** and 250 cells for **NA** and **NdA**.  The cell labels in the counts table were modified adding the groups *N*, *Nd*, *NA* and *NdA*. The rational of the different number of cells for the naive and the activated is due to the expectation that activated cells will be organize in mutiple clusters and naive are expected to be homogeneous. 
...
Thus, we have checked if the removal of 
