...
```{r fig.26, fig.cap="EnrichR analysis. A) Transcription specific enriched paths. B) KEGG specific enriched paths.", echo=FALSE, eval=TRUE, out.width="50%", fig.align="center"}
library(knitr)
...
```{r fig.27, fig.cap="EnrichR analysis. A) Transcription specific enriched paths. B) GO Biological Process specific enriched paths.", echo=FALSE, eval=TRUE, out.width="50%", fig.align="center"}
library(knitr)
include_graphics('../inst/img/c1_specific1.jpeg')
```
