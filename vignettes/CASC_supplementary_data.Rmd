...
In [*Wang](https://www.ncbi.nlm.nih.gov/pubmed/28263960) article it is demonstrated the that SIMLR outperforms other data reductin methods (Figure \ref{fig:fig.18}). Here we run a comparison between SIMLR and tSne within the CASC bootstrap framework.
...
tsneBootstrap(group="docker",scratch.folder="/data/scratch/",
              ...
              logTen=0, seed=111, sp=0.8, clusterPermErr=0.05, perplexity=10)
