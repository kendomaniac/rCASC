...
recatPrediction(group="docker",scratch.folder,file=paste(getwd(), "annotated_buettner_G1G2MS_counts_10000.txt", sep="/"), 
...
\fontsize{10}{10}\selectfont
The analysis above took XXX mins on a [SeqBox](www.seqbox.com), equipped with an Intel i7-6770HQ (8 threads), 32 Gb RAM and 1Tb SSD. 
