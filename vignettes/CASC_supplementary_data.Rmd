...
Figure \ref{fig:fig.17}  shows that the naive T-cytotoxic, T-cytoxic and T-helper, setD, are much similar to naive T-cells with respect to the similarity existing between naive T-cells and the other cells present in setA. 

```{r fig.17, fig.cap="Number of identity between naive T-cells and the other cell types in set A and D", echo=FALSE, eval=TRUE, out.width="80%", fig.align="center"}
library(knitr)
