...
checkCountDepth(group="docker", data.folder=getwd(), counts.matrix="singlecells_counts.txt", 
                conditions=conditions, FilterCellProportion=0.1, 
                FilterExpression=0, ditherCounts=FALSE, 
