...
### **Section 5.1** Stability score formal description.
...
### **Section 5.3** Comparing SIMLR and tSne
...
## **Section 6** Hierarchical clustering: [*Seaurat*](https://satijalab.org/seurat/pbmc3k_tutorial.html) graph-based clustering.
...
```{r fig.32, fig.cap="Seurat dataset PC component.", echo=FALSE, eval=TRUE, out.width="50%", fig.align="center"}
library(knitr)
include_graphics('../inst/img/PCE_bowPlot.png')
```
