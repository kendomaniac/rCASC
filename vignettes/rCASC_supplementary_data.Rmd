...
SIMLR gene prioritization approach relies on the output similarity and does not depend on the downstream dimension reduction or clustering. The advantage of this step is
that one can identify highly fluuctuating genes that are consistent with the learned similarity in the multiple-kernel space.

The function **simlrFeatures** executes SIMLR prioritization within the rCADC bootstrap framework. 
