...
Recently [*Freytag et al.*](https://f1000research.com/articles/7-1297/v1) and [*Do et al*](https://f1000research.com/articles/7-1141/v2) described, in their independent comparison papers, that [*Seurat*](https://satijalab.org/seurat/) delivered the overall best performance. Thus, we decided to include in our workflow also it. Seurat clusters cells based on their PCA scores, with each PC essentially representing a ‘metagene’ that combines information across a correlated gene set. 
