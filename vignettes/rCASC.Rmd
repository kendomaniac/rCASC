...
```{r fig.1, fig.cap="rCASC. A) rCADC workflow. B) Definining the range of clusters to be analysed with SIMLR/tSne. C) Cell stability score within the selected range of clusters. D) SIMLR analysis with bootstaps of the optimal number of clusters, i.e. 5. E) Heatmap of prioritized clusters-specific genes. F) Cell stability score within  clusters-specific genes.", echo=FALSE, eval=TRUE, out.width="70%", fig.align="center"}
library(knitr)
