...
#'}
#' @export
autoencoderAnalysis4Clustering <- function(group=c("sudo","docker"), scratch.folder, file,separator,projectName,seed=1111,Sp){
...
system(paste("cp -r ",data.folder," ",scrat_tmp.folder,"/",sep=""))
  ...
  #executing the docker job
    ...
    params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch:Z -v ", data.folder, ":/data -d docker.io/repbioinfo/analysisforautoclustering Rscript /home/mainAutoencoder.R ",matrixName," ",format," ",projectName," ",separator," ",Sp," ",seed,sep="")
