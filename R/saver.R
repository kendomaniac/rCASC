#' @title Saver
#' @description This function performs Data normalization and prediction with SAVER
...
#'}
#' @export
saver <- function(group=c("sudo","docker"), scratch.folder, file,separator,ncores){
...
system(paste("cp ",data.folder,"/",matrixName,".",format," ",scrat_tmp.folder,sep=""))
  ...
  #executing the docker job
    params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder, ":/data -p 22:22 -d repbioinfo/saver Rscript /home/main.R ",matrixName," ",format," ",separator," ",ncores,sep="")
