...
#' @param clusterMethod, clustering methods: "GRIPH","SIMLR","SEURAT","SHARP","KMEANS","HCLUST"
...
#'}
#' @export
autocluster4clustering <- function(group=c("sudo","docker"), scratch.folder, file, separator, nCluster, projectName, clusterMethod=c("GRIPH","SIMLR","SEURAT","SHARP","KMEANS","HCLUST"),seed=1111,pcaDimensions=20,perplexity=20){
