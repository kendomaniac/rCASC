...
formatT=strsplit(basename(basename(tissuePosition)),"\\.")[[1]][positionsT]
  ...
  #executing the docker job
    params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder, ":/data -d repbioinfo/spatialanalysis Rscript /home/main.R ",matrixName," ",nCluster," ",format," ",separator," ",matrixNameT,sep="")
