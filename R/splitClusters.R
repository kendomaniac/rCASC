...
#'}
#' @export
splitClusters <- function(group=c("sudo","docker"), scratch.folder, file, separator,nCluster){
...
system(paste("cp -r ",data.folder,"/Results/* ",scrat_tmp.folder,"/",sep=""))
  ...
  #executing the docker job
    params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder, ":/data -d docker.io/repbioinfo/mergematrix Rscript /home/main3.R ",matrixName," ",format," ",separator," ",nCluster,sep="")
