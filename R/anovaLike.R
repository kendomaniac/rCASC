...
#' @param ref.cluster, a number indicating the cluster to be use da reference for comparison with the other clusters.
...
#' anovaLike(group="docker", data.folder=getwd(), counts.table="annotated_setPace_10000_noC5_reordered.txt",
