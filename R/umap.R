...
#' @param epochs, number of epochs for umap
...
#' }
#' @export
umap <- function(group=c("sudo","docker"), scratch.folder, file,separator,seed,epochs){
  ...
  params <- paste("--cidfile ",data.folder1,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder1, ":/data -d repbioinfo/umapcoord Rscript /home/main.R ",basename(file)," ",separator," ",seed," ",epochs,sep="")
