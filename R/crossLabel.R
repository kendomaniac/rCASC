...
#' @examples
#'\dontrun{
#'  crossLabel("sudo","/home/lucastormreig/CASC5.0/7_crossLabel/scratch/","/home/lucastormreig/CASC5.0/7_crossLabel/Data/New_Buettner",3,",")# 
#'}
#' @export
...
system(paste("cp -r ",data.folder,"/Results/* ",scrat_tmp.folder,sep=""))
 ...
 params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder, ":/data -d docker.io/rcaloger/crosslabel Rscript /home/main.R ",matrixName," ",nCluster," ",format," ",separator," ",finalName,sep="")
