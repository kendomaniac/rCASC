...
#'                seed=111, sparse=FALSE,format="NULL")
#'}
#' @export

griphBootstrap <- function(group=c("sudo","docker"), scratch.folder, file, nPerm, permAtTime, percent, separator, logTen=0, perplexity=10, seed=111, sparse=FALSE, format=NULL){

 
   permutationClustering(group=group, scratch.folder=scratch.folder, file=file, nPerm=nPerm, permAtTime=permAtTime, percent=percent, separator=separator, seed=seed, logTen=logTen, clustering="griph", perplexity=perplexity, sparse=sparse)
