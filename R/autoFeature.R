#' @title Feature selection for autoencoder
#' @description This function extract feature selection for each clusters. 
...
system(paste("cp -r ",data.folder," ",scrat_tmp.folder,"/",sep=""))
  ...
  #executing the docker job
    ...
    params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch:Z -v ", data.folder, ":/data -d docker.io/repbioinfo/permutationanalysis Rscript /home/main3.R ",projectName," ",matrixName," ",separator," ",nCluster,sep="")
