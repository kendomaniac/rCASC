...
#' @examples
#'\dontrun{
#'clusterReorg("sudo","/home/lucastormreig/CASC2.0/2.1_clusterReorg/scratch/","/home/lucastormreig/CASC2.0/2.1_clusterReorg/Data/TOTAL.csv",3,1,3,",")# 
#'}
#' @export
clusterReorg <- function(group=c("sudo","docker"), scratch.folder, file,nCluster,A,B,separator,sp=0.8){
...
system(paste("cp ",data.folder,"/",matrixName,".",format," ",scrat_tmp.folder,sep=""))
  ...
  #executing the docker job
    params <- paste("--cidfile ",data.folder,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder, ":/data -d docker.io/rcaloger/clustereorg Rscript /home/main.R ",matrixName," ",nCluster," ",A," ",B," ",format," ",separator," ",sp,sep="")
