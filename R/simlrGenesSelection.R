...
genesSelection <- function(group=c("sudo","docker"), scratch.folder, file, nPerm, permAtTime, percent, nCluster, separator, seed=111, sp=0.8, clusterPermErr=0.05, maxDeltaConfidence=0.01, minLogMean=0.05){
