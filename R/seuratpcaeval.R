...
#' @title Estimating the range of PC components to be used in Seurat clustering
#' @description This function estimates the information content of the PCs of the experiment, required by Seurat clustering .
